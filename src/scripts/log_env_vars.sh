...
echo "export FULL_SOURCE_DOCS_PATH=${FULL_SOURCE_DOCS_PATH}" >> $BASH_ENV
echo "export SOURCE_REPO_DIRECTORY=${SOURCE_REPO_DIRECTORY}" >> $BASH_ENV
echo "export TARGET_REPO_DIRECTORY=${TARGET_REPO_DIRECTORY}" >> $BASH_ENV
